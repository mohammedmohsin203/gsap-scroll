              ...
              <div className={style.photos_box}>
                <div className="photo">
                  <div className={style.photo} id={style.col1}>
                    <img
                      src="https://deveb.co/static/media/vim.2c5e9ce4.jpg"
                      className="img"
                    ></img>
                  </div>
                </div>
                <div className="photo">
                  <div className={style.photo} id={style.col1}>
                    <img
                      src="https://deveb.co/static/media/newdopegood.6e57b4b4.jpg"
                      className="img"
                    ></img>
                  </div>
                </div>
                <div className="photo">
                  <div className={style.photo} id={style.col1}>
                    <img
                      src="https://deveb.co/static/media/am-arc.0bba8786.jpg"
                      className="img"
                    ></img>
                  </div>
                </div>
                <div className="photo">
                  <div className={style.photo} id={style.col1}>
                    <img
                      src="https://deveb.co/static/media/dopegood.b2cad70d.jpg"
                      className="img"
                    ></img>
                  </div>
                </div>
